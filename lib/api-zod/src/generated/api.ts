...
export const ListJobsResponseItem = zod.object({
  ...
  address: zod.string().nullish(),
  builderCompanyName: zod.string().nullish(),
...
export const CreateJobBody = zod.object({
  ...
  address: zod.string().optional(),
  builderCompanyName: zod.string().optional(),
...
export const ListDispatchResponseItem = zod.object({
  ...
  jobAddressVisible: zod.boolean().optional(),
  addressVisibilityReason: zod.string().optional(),
